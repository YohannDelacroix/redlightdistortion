...
import YohannPic from "../../Assets/yohann.jpg";
    ...
    <div className="about-container">
      ...
      <div className="about-biography">
        ...
        <div className="about-member-biography-left">
          <img className="about-img-yohann" src={YohannPic} alt="beautiful picture of X" />
          <h3>X</h3>
          <h5 className="about-title-right">Yohann Delacroix</h5>
        ...
        <img className="about-img-roman" src={YohannPic} alt="beautiful picture of X" />
          ...
          <h3>Walrus</h3>
          <h5 className="about-title-left">Roman Krukowski</h5>
